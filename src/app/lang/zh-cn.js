...
I18N.EM.Tool.Calendar.NoneWorkTime = '非工作时间分析';
I18N.EM.Tool.Calendar.HotColdSeason = '冷暖季分析';
...
I18N.EM.Report.ExportFormat = '导出格式（选填）';
...
I18N.Setting.Tag.OffsetView = '偏移';
I18N.Setting.Tag.OffsetTime = '偏移发生时间';
I18N.Setting.Tag.OffsetHistory = '历史偏移值';
I18N.Setting.Tag.OffsetCurrentHint = '请输入本次偏移值';
I18N.Setting.Tag.OffsetHint = '请输入偏移值';
I18N.Setting.Tag.OffsetDate = '请选择日期';
I18N.Setting.Tag.OffsetHour = '请选择时间';
I18N.Setting.Tag.OffsetMinute = '请选择分钟';
...
I18N.Message.M02028 = '所选数据点不支持峰平谷分析！';
...
I18N.Kpi = {
  ...
  Error:{
    ...
    NonKPICongured: '暂无指标现状，请点击上方按钮进行配置',
...
I18N.Setting.VEEMonitorRule.JumpValue = '跳变';
I18N.Setting.VEEMonitorRule.JumpValueTip = '≥当前跳变幅度，将发送报警邮件。';
I18N.Setting.VEEMonitorRule.JumpValueErrorMsg = '请输入正数，支持小数点后一位';
...
I18N.Setting.Cost.ComplexPrice = '峰平谷电价';
...
I18N.Setting.Cost.UsageCost = '峰平谷电价引用';
...
I18N.Setting.KPI.YearAndType.DosageAbbr= '用量类';
I18N.Setting.KPI.YearAndType.RatioAbbr= '比值类';
...
I18N.Setting.KPI.Parameter.QuotaErrorText= '请输入大于等于0的数字，支持小数点后两位';
...
I18N.Setting.KPI.Group.GroupConfig.Annual= '{0}集团{1}指标';
I18N.Setting.KPI.Group.GroupConfig.InputAnnual= '输入{0}集团{1}指标';
...
I18N.Setting.KPI.Group.BuildingConfig.Indicator='建筑{0}指标';
I18N.Setting.KPI.Group.BuildingConfig.IndicatorHint='输入建筑{0}指标';
...
I18N.Setting.Diagnose.SimilarProblemList='相似问题列表';
...
I18N.Setting.Diagnose.LeavePageTip='您的所有操作将不会保存，确定离开当前页面吗？';
...
I18N.Setting.Diagnose.Industry='适用行业';
I18N.Setting.Diagnose.RiskDescription='风险描述';
...
I18N.SaveEffect.Create.ConfigCalcStep = '计算步长';
...
I18N.SaveEffect.Create.StepTip = '所选数据点步长与计算步长不匹配。';
...
I18N.SaveEffect.Create.AuxiliaryTrigger = '关联值触发条件';
I18N.SaveEffect.Create.ActualTrigger = '触发条件';
I18N.SaveEffect.Create.Greater = '大于';
I18N.SaveEffect.Create.Less = '小于';
I18N.SaveEffect.Create.AuxiliaryHint = '请输入关联值';
I18N.SaveEffect.Create.ActualHint = '请输入触发值';
I18N.SaveEffect.Create.TriggerVaildTip = '仅数字，支持小数点后6位';
I18N.SaveEffect.Create.TriggerArea = '诊断条件触发区域';
...
I18N.VEE.NoChoiceTip= '请在左侧选择要查看的节点';
