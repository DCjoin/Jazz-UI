...
I18N.DateTimeFormat.IntervalFormat.Month = 'MM, YYYYY';
...
I18N.Setting.TOUTariff.Name = 'Cost config';
...
I18N.Setting.CarbonFactor.DeleteTitle = 'Delete conversion factor “{0}”';
I18N.Setting.CarbonFactor.DeleteContent = 'Conversion factor “{0}” will be deleted';
I18N.Setting.TOUTariff.DeleteTitle = 'Delete "{0}"';
I18N.Setting.TOUTariff.DeleteContent = '"{0}" will be deleted';
I18N.Setting.Role.DeleteTitle = 'Delete role "{0}"';
