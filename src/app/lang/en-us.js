...
I18N.VEE.CloseMonitorTip= '关闭数据监测后，下一周期将不再进行扫描监测。确定关闭数据监测吗？';
I18N.VEE.CreateDataStructure= '新建数据流架构';
I18N.VEE.StartMonitor= '该建筑已开启数据监测';
I18N.VEE.CloseMonitor= '该建筑已关闭数据监测';
I18N.VEE.ChooseMonitorDate= '请选择开始监测时间';
I18N.VEE.ChooseMonitorDateTip= '选择开始监测时间';
I18N.VEE.SelectDate= '选择时间';
I18N.VEE.MonitorErrorTip= '请完整填写监测日期和时间';
I18N.VEE.Refresh= '刷新页面';
I18N.VEE.RefreshTip= '刷新页面获取新数据流架构';
I18N.VEE.AllNode= '全部节点';
I18N.VEE.ConfigRule= '配置规则';
I18N.VEE.ManageData= '管理数据流';
I18N.VEE.StartMonitorBtn= '开启数据扫描';
I18N.VEE.CloseMonitorBtn= '关闭数据扫描';
I18N.VEE.NoChoiceTip= '请在左边选择要查看的节点';
I18N.VEE.Notice = {};
