...
I18N.VEE.Notice.RollBackSuccess = '撤销修复成功';
I18N.VEE.Monitor= '异常监测';
I18N.VEE.Basic= '基础属性';
I18N.VEE.MonitorRule= '监测规则';
I18N.VEE.Rule = {};
I18N.VEE.Rule.Tip = '监测规则集（每日扫描时间点为1:00,9:00,17:00）';
I18N.VEE.Rule.NoRule = '该数据点暂未配置监视规则，点击下方“编辑”按钮配置规则';
I18N.VEE.Rule.NotifyConsecutiveHoursTip1 = '当空值连续出现';
I18N.VEE.Rule.NotifyConsecutiveHoursTip2 = '通知用户';
...
I18N.VEE.ErrorMsg = '请输入数字（小数点前最多9位、小数点后最多6位）';
I18N.VEE.offlineTab = '在线/离线';
I18N.VEE.TransLineInfo = '传输节点关联状态';
I18N.VEE.onlineText = '在线';
I18N.VEE.offlineText = '离线';
I18N.VEE.NoneOnlineandOfflineInformation = '暂无关联信息';
...
I18N.VEE.BasicProperty.DeviceType = '设备类型';
I18N.VEE.BasicProperty.DeviceTypeNumber = '设备型号';
I18N.VEE.BasicProperty.CollectionType = '采集方式';
I18N.VEE.BasicProperty.WatchCode = '表编码';
I18N.VEE.BasicProperty.Channel = '通道';
I18N.VEE.BasicProperty.CollectionTime = '采集周期';
I18N.VEE.BasicProperty.ComputeType = '计算方式';
I18N.VEE.BasicProperty.IsAllCompute = '是否累计计算';
I18N.VEE.BasicProperty.Medium = '介质';
I18N.VEE.BasicProperty.Unit = '单位';
I18N.VEE.BasicProperty.ResourceTag = '能源标签';
I18N.VEE.BasicProperty.Rate = '斜率';
I18N.VEE.BasicProperty.Offset = '偏移量';
