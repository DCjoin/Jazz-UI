...
var ViewableDatePicker = React.createClass({
    ...
    _onSelectedDate(date){
        this.setState({curDate:moment(date).format('YYYY/MM/DD'),showCalendar:false});
    ...
    render: function(){
        ...
        if(!this.props.isViewStatus){
          ...
          var inputProps = {
              ...
              style: assign({ width: 430 }, this.props.style)
          };
          ...
          calendar=(<div style={{position:'absolute',"zIndex":99,width:"315px","backgroundColor":"white"}}><Calendar
                ref="calendar"
