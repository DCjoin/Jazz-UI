...
let ChartStrategyFactor = {
 ...
 searchBarGenFnStrategy:{
   energySearchBarGen(analysisPanel){
     var rankTypeCombo = ChartStrategyFactor.getRankType(analysisPanel);
 ...
 getRankType(analysisPanel){
   var rankTypeCombo = <div className={'jazz-full-border-dropdownmenu-relativedate-container'} >
     <DropDownMenu menuItems={rankType} ref='rankType' style={{width:'92px'}}></DropDownMenu>
   </div>;
   return rankTypeCombo;
 },
 getSearchBtn(analysisPanel){
   var searchButton = <RaisedButton label='查看' onButtonClick={analysisPanel.onSearchDataButtonClick}></RaisedButton>;
   return searchButton;
 },
