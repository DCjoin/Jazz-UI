...
var xAxisTag,yAxisTag,TimeRanges;
...
export default class ScatterPlot extends Component {
  ...
  _renderAxisSelect(){
    var menus=AlarmTagStore.getSearchTagList().map(tagNode=> <MenuItem primaryText={tagNode.tagName} value={tagNode.tagId} style={{fontSize:'12px'}}/>);
    menus.unshift(
      <MenuItem primaryText={I18N.Setting.DataAnalysis.Scatter.PlzSelectTag} value={0} disabled={true} style={{fontSize:'12px'}}/>
    )
    return(
      <div style={{position:'absolute',right:'20px',top:'50px',backgroundColor:'#ffffff'}}>
        <div style={{display:'flex',flexDirection:'row',alignItems:'center'}}>
         ...
         <DropDownMenu style={{width: '125px',height:'30px',marginLeft:'10px'}} 
                        ...
                        labelStyle={{height:'28px',lineHeight:'30px',paddingLeft:'10px',paddingRight:'0',fontSize:'12px',border:"1px solid #e6e6e6",borderRadius: "4px"}} 
                        value={this.state.xAxis} 
                        onChange={(e, selectedIndex, value)=>{this.setAxisData(value,this.state.yAxis)}}>
           {menus}
         </DropDownMenu>
        </div>
        <div style={{display:'flex',marginTop:'10px',flexDirection:'row',alignItems:'center'}}>
         ...
         <DropDownMenu style={{width: '125px',height:'30px',marginLeft:'10px'}} 
                       iconButton={<IconButton iconClassName="icon-arrow-down" iconStyle={{fontSize:"10px"}} style={{width:14,height:14}}/>}                    
                       iconStyle={{marginTop:'-12px',padding:'0',right:'15px',width:'24px',top:"2px"}}
                       labelStyle={{height:'28px',lineHeight:'30px',paddingLeft:'10px',paddingRight:'0',fontSize:'12px',border:"1px solid #e6e6e6",borderRadius: "4px"}} value={this.state.yAxis} 
                       onChange={(e, selectedIndex, value)=>{this.setAxisData(this.state.xAxis,value)}}>
           {menus}
         </DropDownMenu>
        </div>
      </div>
